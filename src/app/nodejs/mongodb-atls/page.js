...
<div className=' flex justify-center sm:justify-center sm:mx-5'><h4 className=' text-green-300'>git command exiting folder upload to github server</h4></div>
  <div className=' mx-10'>
    ...
    After getting this sanity, you all have to run the github command or after that you have to run the git command again which is given below, what do you have to run so that the exiting folder can be uploaded to github again?
      ...
      <div className=' flex justify-center sm:mx-5'><h2 className=' text-green-400'> how to add folder to github from vscode </h2></div>
